    ...
    showScheduleSideEffect.observeWithLifecycle {
        when (it) {
            ...
            FetchScheduleSideEffect.DeleteScheduleDateError -> {
                toast(HomeMessage.Schedule.DeleteScheduleNotFound)
            }

            FetchScheduleSideEffect.DeleteScheduleCannotFound -> {
                toast(HomeMessage.Schedule.ScheduleNotFound)
            }
        }
    }
            ...
            sheetContent = {
                if (deleteCheck) {
                    Column(
                        ...
                        Body3(text = HomeMessage.Schedule.DeleteSchedule(scheduleTitle))
